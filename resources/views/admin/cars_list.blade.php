...
<head>
    ...
    <title>Cars List | Car Rental</title>
    ...
    <style>
        ...
        .btn-add:hover { background: #e09410; color: #fff; text-decoration: none; }
        .action-btn {
            padding: 4px 10px;
            font-size: 12px;
            border-radius: 5px;
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            @else
                                <div class="no-thumb"><i class="fa fa-car" style="color:#ccc;"></i></div>
                            @endif
                        </td>
                        ...
                        <td>RM {{ number_format($car->deposit, 2) }}</td>
                        <td>
                            @if($car->is_available)
                    ...
                    <tr>
                        <td colspan="14" class="text-center text-muted py-4">
                            No cars found. <a href="{{ route('admin.fleet.create') }}" style="color:#f5a425;">Add one now.</a>
                        </td>
                    </tr>
                    @endforelse
                </tbody>
